...
/**
 * La classe royaume g�re le plateau de jeux que poss�de chaque joueur.
 *
 */
public class Royaume {
	...
	/**
	 * Constructeur de la classe Royaume new Royaume() va cr�er un royaume vierge
	...
	/**
	 * Fonction recursive qui scanne un domaine (groupe de cases du meme type) �
	 * partir d'une premiere case. Le cas de base �tant une case d�j� trait�e, un
	 * chateau ou une case vide.
	 * 
	 * On ajoute la case � la liste des cases d�j� trait�es pour �tre certain de ne
	 * pas la compter deux fois. La fonction 10*x+y r�alise une bijection entre les
	 * cases et les entiers entre 0 et 88 la table contient donc ces entiers plut�t
	 * que les coordon�es ce qui facilite la d�tection d'une case d�j� trait�e.
	 * 
	 * Avant de regarder autour de la case x,y on v�rifie successivement que : -la
	 ...
	 * @param casesDejaTraitees liste des cases d�j� trait�es par le comptage
	...
	public int[] points(int x, int y, ArrayList<Integer> casesDejaTraitees) {
		...
		} catch (NumberFormatException e) { // erreur due a la lecture de null comme string
			couronne = 0;
		}
		int[] res = new int[2];
	...
	/**
	 * La fonction score appelle la fonction point sur chaque case et cr�e une liste
	 ...
	 * 
	 * @return true si harmonie est verifi� false sinon
	 */
	...
	/**
	 * Place la tuile d�crite en param�tre dans le royaume aux coordonn�es indiqu�es
	 * 
	 * Cette fonction sera utilis�e suite � la v�rification du placement de la tuile
	 * par la methode v�rification.
	 * 
	 * @param x1    abscisse de la premi�re case de la tuile
	 * @param y1    ordonnee de la premi�re case de la tuile
	 * @param compteEcart
	 * @param case1 couple type/couronne de la premi�re case de la tuile
	 */
	...
	/**
	 * La fonction v�rifie que la case entr�e en param�tre peut �tre plac�e dans le
	 * royaume aux coordonn�es entr�es en param�tre.
	 * 
	 * Elle v�rifie successivement que la case n'est pas d�j� occup�e, qu'une case
	 * autour � le m�me type que celui de la case � placer ou bien est un chateau,
	 * que le royaume reste 5X5 et que le placement n'est pas hors du royaume.
	 *
	 * 
	 * @param x1    abscisse de la case
	 * @param y1    ordonn�e de la case
	...
	/**
	 * La fonction resteValide v�rifie que le fait de poser une case aux coordonn�es
	 * en argment n'enfreins pas la r�gle qui d�finie les limites du royaume (5*5 ou
	 * 7*7)
	 * 
	 * @param x1
	 * @param y1
	 * @return Le boolean correspondant � la r�ponse
	 */
	...
	/**
	 * Renvoie le type de la case du royaume dont les coordonn�es sont en param�tre.
	 * 
	...
	/**
	 * Renvoie le nombre de couronne de la case du royaume dont les coordonn�es sont
	 * en param�tre.
	 * 
	 * @param abscisse de la case
	 * @param ordonnee de la case
	...
	/**
	 * 
	 * @return Le tableau contenant les �carts horizontaux maximums avec le chateau
	 */
	...
	/**
	 * 
	 * @return Le tableau contenant les �carts verticaux maximums avec le chateau
	 */
	...
	/**
	 * Permet de r�initialiser l'�cart lorque un joueur annule son coup Pour ca le
	 * tableau est parcouru et les valeurs enrengistr�es corespondent aux premieres
	 * et dernieres lignes/colones ou on trouve une case utilis�e.
	 */
	...
	/**
	 * La fonction verifie que la pose de la secconde case ne d�pace pas les limites
	 * du royaume.
	 * 
	 * @param direction
	 * @param nvCoor
